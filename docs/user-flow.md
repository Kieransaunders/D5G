...
| Real Divi preview | `divi5-deploy` `/preview` step | Before full WordPress import | User rejects preview or render is visibly broken |
| Live visual check | `divi5-deploy` screenshot / `visual-diff.js` | After import | Render drift above threshold or visible live-page defects |
