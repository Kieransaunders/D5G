...
When `et-pages.js match` returns a result for the brief, the mutated clone MUST be the
file imported to WordPress. A parallel from-scratch page MUST NOT be generated or
preferred. SKILL.md MUST NOT contain language preferring the scratch page over the clone.
