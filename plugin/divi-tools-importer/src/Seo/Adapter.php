 ...
 *
 * write() receives a *normalised* SEO payload (see DTI_Seo_Normaliser) — never
 ...
 */
interface DTI_Seo_Adapter {

	/**
	 * Stable adapter identifier. Lowercase, no spaces. Used in ping/import
	 * responses and in the dti/seo/adapter_order filter.
	 */
	 ...
	 * @param array $seo     Normalised payload (see DTI_Seo_Normaliser::normalise()).
